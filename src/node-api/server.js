...
app.listen(PORT, () => { console.log(`✅ Secure API server running on port ${PORT}`); if (!process.env.JWT_SECRET) console.warn('⚠️  WARNING: Using auto-generated JWT_SECRET. Set JWT_SECRET in .env for production!'); });
